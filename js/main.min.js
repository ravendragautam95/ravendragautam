...
/*!-Scroll to Top*/
i.on("debouncedresize",(function(){window.innerWidth>dtLocal.themeSettings.mobileHeader.firstSwitchPoint&&!s.hasClass("responsive-off")||s.hasClass("responsive-off")?t(".masthead:not(.side-header):not(.mixed-header)").length>0?dtGlobals.showTopBtn=t(".masthead:not(.side-header):not(.mixed-header)").height()+150:t(".masthead.side-header-h-stroke").length>0?dtGlobals.showTopBtn=t(".side-header-h-stroke").height()+150:dtGlobals.showTopBtn=500:dtGlobals.showTopBtn=500})),i.scroll((function(){dtGlobals.winScrollTop>dtGlobals.showTopBtn?t(".scroll-top").removeClass("off").addClass("on"):t(".scroll-top").removeClass("on").addClass("off")})),t(".scroll-top").click((function(t){return t.preventDefault(),je("up"),!1}));var me=t(".woocommerce-NoticeGroup-updateOrderReview, .woocommerce-NoticeGroup-checkout");!me.length&&t("form.checkout").exists()&&(me=t("form.checkout").parents(".content").offset().top),t(document.body).on("checkout_error",(function(){t("html, body").animate({scrollTop:me-De.height()},"slow")})),
/*!-Custom select*/
